...
cd "$(dirname "$0")"
swiftc -O -swift-version 5 -o ThongpariFlyNeuronSim main.swift FlyModel.swift FlyGymBridge.swift LabProtocol.swift LabGraphView.swift ExperimentRecorder.swift LabWindow.swift SensoryModel.swift MotorReadout.swift \
