...
- 조회한 HEAD: `3ad60db` (`Prepare Virtual Fly Lab V4 implementation`). V4 구현 관련 dirty/untracked 파일이 있으므로 보존한다.
...
- V5–V14: 계획. **다음 구현 버전은 V5**이며 V4 완료 보고서와 V5 상세 계획을 읽고 시작한다.
